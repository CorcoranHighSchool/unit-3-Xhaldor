...
func getFortune(cardSuit: Suit) {
    switch cardSuit {
    case .clubs :
        print("You will find what you seek.")
    case .hearts :
        print("You will find the thing you love the most")
    case .spades :
        print("You will be in a great event.")
    case .diamonds :
        print("You shall recieve what you didn't seek.")
    default:
        print("Error!")
    }
}
